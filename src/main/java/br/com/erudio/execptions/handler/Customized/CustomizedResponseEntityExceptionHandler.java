package br.com.erudio.execptions.handler.Customized;

import br.com.erudio.execptions.ExecptionResponse;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ExecptionResponse> handleAllExceptions(
    ...
    public final ResponseEntity<ExecptionResponse> handleBadRequestExceptions(
            Exception ex, WebRequest request) {
        ExecptionResponse execptionResponse = new ExecptionResponse(
                new Date(),
                ex.getMessage(),
